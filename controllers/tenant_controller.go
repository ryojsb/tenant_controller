...
import (
	...
	multitenancyv1 "my.domain/tenant/api/v1"
)
...
//+kubebuilder:rbac:groups=multitenancy.my.domain,resources=tenants,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=multitenancy.my.domain,resources=tenants/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=multitenancy.my.domain,resources=tenants/finalizers,verbs=update
